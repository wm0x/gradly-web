...
export default function DashboardHome() {
    const todayProject =  Math.floor(Math.random() * 10) + 1;
    const stats = {
        totalProjects: 507,
        todayProjects: todayProject , 
        yearlyProjects: todayProject + Math.floor(Math.random() * 100) + 1,
        lastProjects: [
            {
                name: "Gradly - Grad Projects Portal",
                description:
                    " A platform for managing and showcasing graduate projects",
                date: "2025-11-15",
                category: "website graduate",
            },
            {
                name: "Syntax - Code Editor",
                description:
                    "Full-featured online shopping solution with analytics",
                date: "2025-11-14",
                category: "ideas website",
            },
            {
                name: "Mobile Banking App",
                description: "Secure financial application with biometric auth",
                date: "2025-11-12",
                category: "Mobile ideas",
            },
            {
                name: "Analysis medical data",
                description: "AI-driven insights for healthcare professionals",
                date: "2025-11-10",
                category: "research",
            },
            {
                name: "AI Generator",
                description: "Automated content creation with GPT integration",
                date: "2025-11-08",
                category: "AI",
            },
        ],
                ...
                <div className="bg-[#1a1a1a] p-4 md:p-6 rounded-xl border border-white/5 duration-300 hover:border-cyan-500/30 transition-all group hover:shadow-lg hover:shadow-cyan-500/10">
                    <div className="flex items-center justify-between">
                        ...
                        <div className="p-2 md:p-3 rounded-lg bg-cyan-500/10 text-cyan-400 group-hover:bg-cyan-500/20 duration-300">
                            <FiPlusCircle size={20} className="md:w-6 md:h-6" />
                        </div>
                    </div>
                    <div className="mt-3 md:mt-4 pt-3 md:pt-4 border-t border-white/5">
                        <p className="text-xs text-white/50 flex items-center">
                            ...
                            >
                                <div className="flex flex-col md:flex-row md:items-center md:justify-between gap-4">
                                    ...
                                    <div className="flex items-center justify-between md:justify-end gap-4">
                                        ...
                                        <button
                                            className="p-2 rounded-lg bg-white/5 text-white/50 hover:bg-emerald-500/10 hover:text-emerald-400 transition-colors"
