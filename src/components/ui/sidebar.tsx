...
export const DesktopSidebar = ({
  ...
  return (
    <>
      <motion.div
        className={cn(
          "h-full px-4 py-4 hidden  md:flex md:flex-col bg-black/80 w-full shrink-0",
          className
        )}
        animate={{
        ...
        <AnimatePresence>
          {open && (
            <motion.div
              ...
              className={cn(
                "fixed h-full w-full inset-0 bg-black/90 rounded p-10 z-[100] flex flex-col justify-between",
                className
              )}
            >
              <div
